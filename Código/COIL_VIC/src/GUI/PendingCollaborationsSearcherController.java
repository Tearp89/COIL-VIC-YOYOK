...
public class PendingCollaborationsSearcherController {
    private static final org.apache.log4j.Logger LOG = Log.getLogger(PendingCollaborationsSearcherController.class);
    @FXML
