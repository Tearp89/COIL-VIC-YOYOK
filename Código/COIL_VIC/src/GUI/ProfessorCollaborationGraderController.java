...
public class ProfessorCollaborationGraderController {
    private static final org.apache.log4j.Logger LOG = Log.getLogger(ProfessorCollaborationGraderController.class);
    @FXML
