...
public class RequestToCollaborateSearcherController {

    private static final org.apache.log4j.Logger LOG = Log.getLogger(RequestToCollaborateSearcherController.class);
