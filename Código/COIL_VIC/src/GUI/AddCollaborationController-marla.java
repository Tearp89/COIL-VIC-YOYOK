...
public class AddCollaborationController {    
    ...
    void addCollaboration(ActionEvent event) {
        ...
        String collaborationType = comboBoxCollaborationType.getSelectionModel().getSelectedItem();    
        ...
        if(!CollaborationValidator.validateCollaborationFields(collaboration, instance)){
           return;
        } else if(CollaborationValidator.validateCollaborationName(collaboration, collaborationDAO)){
            int result = collaborationDAO.addCollaboration(collaboration);
            CollaborationValidator.showAlerts(result, collaborationDAO, collaboration);
        }
