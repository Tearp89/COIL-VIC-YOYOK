...
public class AdminCollaborationGraderController {
    private static final org.apache.log4j.Logger LOG = Log.getLogger(AdminCollaborationGraderController.class);
